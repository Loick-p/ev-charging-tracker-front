...
import { Calendar as CalendarIcon, Car, Euro, Eye, PlugZap, Wallet, Zap } from "lucide-react"
                                ...
                                {dateRange?.from ? (
                                    dateRange.to ? (
                                        <>
                                            ...
                                            {format(dateRange.to, "dd/MM/yyyy", { locale: dateFnsFr })}
                                        </>
                                    ) : (
                                        format(dateRange.from, "dd/MM/yyyy", { locale: dateFnsFr })
                                    )
                    ...
                    <div className="grid grid-cols-1 gap-2 xl:grid-cols-3 lg:gap-4 mb-4">
                        <Card>
                            <CardHeader>
                                ...
                                <CardTitle className="text-muted-foreground font-light">Total chargings</CardTitle>
                            </CardHeader>
                            <CardFooter>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardTitle className="text-muted-foreground font-light">Total kWh</CardTitle>
                            </CardHeader>
                            <CardFooter>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardTitle className="text-muted-foreground font-light">Total cost</CardTitle>
                            </CardHeader>
                            <CardFooter>
